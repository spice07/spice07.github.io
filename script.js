...
ジュン　　 への 信頼　■■■■　疑心暗鬼(あなた以外の全ての姉妹の最大行動値に-1)
ネージュ　 への　　　 ■■■□　()
クロエ　　 への　　　 ■■■□　()
　　　　　 への　　　 ■■■□　()
　　　　　 への　　　 ■■■□　()
...
メモ：
中性的な見た目をしている。そこそこしっかりした身体ではあるけどどっちだか正直よく分からない。聞いてもとぼけられるのでやっぱり分からない。

1na+2　肉切り包丁】コス2射程0白兵2　　→災禍+ジェットノズル+スパイク+有刺鉄線→+コス3基本1で＋ダメ4+全体`;
});
